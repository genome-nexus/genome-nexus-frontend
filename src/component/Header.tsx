        ...
        return (
            <header className="sticky-top">
                        ...
                        <Navbar.Collapse>
                            <Nav>
                                ...
                                <LinkContainer exact={true} to="/annotation">
                                    <Nav.Link>MAF Annotation</Nav.Link>
                                </LinkContainer>
                                <LinkContainer exact={true} to="/patient">
                                    <Nav.Link>Patient Report</Nav.Link>
                                </LinkContainer>
                                <LinkContainer exact={true} to="/api">
                                    <Nav.Link>API Usage</Nav.Link>
                                </LinkContainer>
                            </Nav>
                        </Navbar.Collapse>
                        <MskccLogo
                ...
                <Navbar
                    bg="mskcc-subheader"
                    expand="lg"
                    className="navbar-dark sub-navbar"
                >
                    <Container>
                        A resource for annotation and interpretation of genetic
                        variants
                    </Container>
                </Navbar>
            </header>
