...
> {
    public render() {
        ...
        return (
            <div
                className={functionalGroupsStyle['gnomad-frequency-table']}
                data-test="gnomad-table"
            >
                <ReactTable
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            width: 120, // MODIFIED: inscrese the width since number is longer than scientific notation
                        },
                    ]}
                />
                <div
