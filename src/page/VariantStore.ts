...
export class VariantStore {
    ...
    readonly curiousCases = remoteData({
        ...
        invoke: async () => {
            ...
            else if(this.annotation.result?.variant ==  '5:112151184A>G') {
                return {
                    genomicLocation: '4,55593580,55593580,A,T',
                    comment:
            ...
            else if(this.annotation.result?.variant ==  '3:52439306A>G') {
                return {
                    genomicLocation: '4,55593580,55593580,A,T',
                    comment:
            ...
            else if(this.annotation.result?.variant ==  '17:7579883G>A') {
                return {
                    genomicLocation: '4,55593580,55593580,A,T',
                    comment:
            ...
            else if(this.annotation.result?.variant ==  '12:25380277G>T') {
                return {
                    genomicLocation: '4,55593580,55593580,A,T',
                    comment:
